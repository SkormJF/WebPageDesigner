...
8. Add a `## Backend & Data Model` section to `PROJECT-BRIEF.md`: entities, relationships, roles/states, and which secrets live in `site/.env.local` (never the values themselves).
