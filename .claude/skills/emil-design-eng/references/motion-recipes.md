...
Implementation detail for `emil-design-eng`, kept out of the main skill so it loads only when a specific
technique is actually being written. Nothing here changes what should be built — see the skill for that.
