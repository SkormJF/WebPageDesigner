...
| `emil-design-eng` | Pulido de animaciones y micro-interacciones — filosofia de Emil Kowalski |
| `design-taste-frontend` | Contrarresta el sesgo de diseno por defecto de la IA con reglas metricas de tipografia y layout |
| `full-output-enforcement` | Evita que Claude trunque codigo o deje placeholders |
| `imagegen-frontend-web` | Genera una imagen de referencia por seccion para alinear la direccion visual |
| `redesign-existing-projects` | Auditoria estructurada + ruta de mejora para un sitio existente |
...
│       ├── emil-design-eng/        # Pulido de animaciones y micro-interacciones
│       ├── design-taste-frontend/  # Reglas anti-sesgo de diseno IA
│       ├── full-output-enforcement/ # Anti-truncado, salida completa de archivos
...
Todos los derechos reservados — ve [LICENSE](LICENSE). Proyecto privado, no licenciado para redistribucion.
